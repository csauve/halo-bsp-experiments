...
# attempt 4: removed phantom BSP with no apparent artifacts -- simpler solution
def fix_d():
    bsp3d_nodes[8198].back_child = bsp3d_nodes[8198].front_child

# attempt 3: removed phantom BSP with no apparent artifacts
def fix_c():
    bsp3d_nodes[8198].back_child = 8195

# attempt 2: the top of the ramp became a collisionless hole
def fix_b():
    bsp3d_nodes[8197].front_child = bsp3d_nodes[8198].front_child

# attempt 1: this produced additional phantom BSP
def fix_a():
